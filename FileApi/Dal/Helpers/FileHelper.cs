...
/// <summary>
/// Helper для работы с файлами в Dal
/// </summary>
public static class FileHelper
{
    ...
    private static IDictionary<string, string> BuildMappings()
    {
        var mappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) {
            ...
            {".xlsx2", "application/vnd.openxmlformats-officedocument.spreadsheetml.xlsx"},
    ...
    /// <summary>
    /// В переданном классе проверяем свойства, которые не равны null и применяем к ним Action
    /// </summary>
